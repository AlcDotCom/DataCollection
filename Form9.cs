    ...
    public partial class Form9 : Form
    {
        ...
        public Form9()
        {
            ...
            try   //Detail / upresnenie
            {
                ...
                {
                    SqlCommand sqlCmd = new SqlCommand("SELECT KategoriePROCES FROM DowntimeOptions WHERE Linka = '" + Settings.Default.NazovZariadenia.ToString() + "'", sqlConnection);
                    sqlConnection.Open();
                    SqlDataReader sqlReader = sqlCmd.ExecuteReader();

                    while (sqlReader.Read())
                    {
                        comboBox2.Items.Add(sqlReader["KategoriePROCES"].ToString());
                    }
                    sqlReader.Close();
                }
            }
            ...
            else                                                                      
            {
                try
                {
                    ...
                    if (con.State == ConnectionState.Open)
                    {
                        ...
                        string q = "insert into DowntimeTable (Prestoj,KategoriaPrestoja,Linka,DatumZapisu,ZaciatokPrestoja,KoniecPrestoja,TrvaniePrestoja,Zmena,HotovyVyrobok,VstupnyMaterial,Stanica,Detail,ZastavenieVyroby,PoruchuOdstranil,PricinaAleboPopisPoruchy,VykonaneOpatrenieOprava,StrataOperator,CenaOperator1hod,Status,Rezerva1,Rezerva2,Rezerva3,Rezerva4,Rezerva5)values('" + "Prestoj" + "','" + "Proces" + "','" + NazovZariadenia.ToString() + "','" + time.ToString(format) + "','" + textBox1.Text.ToString() + "','" + textBox2.Text.ToString() + "','" + trvanie.ToString() + "','" + zmena.ToString() + "','" + "N/A" + "','" + "N/A" + "','" + "N/A" + "','" + comboBox2.SelectedItem.ToString() + "','" + comboBox5.SelectedItem.ToString() + "','" + textBox3.Text.ToString() + "','" + textBox4.Text.ToString() + "','" + textBox5.Text.ToString() + "','" + strata.ToString() + "','" + Cena1hod.ToString() + "','" + "Aktivny" + "','" + "N/A" + "','" + "N/A" + "','" + "N/A" + "','" + "N/A" + "','" + "N/A" + "')";
