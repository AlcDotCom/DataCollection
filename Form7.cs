    ...
    public partial class Form7 : Form
    {
        ...
        public Form7()
        {
            ...
            { 
                ...
                comboBox2.Font = new Font(comboBox2.Font.FontFamily, 14);
            }
            ...
            try   //nacita výrobky
            {
                ...
                {
                    SqlCommand sqlCmd = new SqlCommand("SELECT HotovyVyrobok FROM DowntimeOptions WHERE Linka = '" + Settings.Default.NazovZariadenia.ToString() + "'", sqlConnection);
                    sqlConnection.Open();
                ...
                comboBox4.Items.Add("Iné");

                if (comboBox4.Items.Count > 3)
            ...
            try   //kategórie nekvalita
            {
                using (SqlConnection sqlConnection = new SqlConnection(Connection.ConnectionString))
                {
                    SqlCommand sqlCmd = new SqlCommand("SELECT KategorieNEKVALITA FROM DowntimeOptions WHERE Linka = '" + Settings.Default.NazovZariadenia.ToString() + "'", sqlConnection);
                    sqlConnection.Open();
                    SqlDataReader sqlReader = sqlCmd.ExecuteReader();

                    while (sqlReader.Read())
                    {
                        comboBox2.Items.Add(sqlReader["KategorieNEKVALITA"].ToString());
                    }
                    sqlReader.Close();
                }
            }
            ...
            else                                                                      
            {
                try
                {
                    ...
                    if (con.State == ConnectionState.Open)
                    {
                        ...
                        string q = "insert into DowntimeTable (Prestoj,KategoriaPrestoja,Linka,DatumZapisu,ZaciatokPrestoja,KoniecPrestoja,TrvaniePrestoja,Zmena,HotovyVyrobok,VstupnyMaterial,Stanica,Detail,ZastavenieVyroby,PoruchuOdstranil,PricinaAleboPopisPoruchy,VykonaneOpatrenieOprava,StrataOperator,CenaOperator1hod,Status,Rezerva1,Rezerva2,Rezerva3,Rezerva4,Rezerva5)values('" + "Prestoj" + "','" + "Nekvalita" + "','" + NazovZariadenia.ToString() + "','" + time.ToString(format) + "','" + textBox1.Text.ToString() + "','" + textBox2.Text.ToString() + "','" + trvanie.ToString() + "','" + zmena.ToString() + "','" + comboBox4.SelectedItem.ToString() + "','" + comboBox1.SelectedItem.ToString() + "','" + "N/A" + "','" + comboBox2.SelectedItem.ToString() + "','" + comboBox5.SelectedItem.ToString() + "','" + textBox3.Text.ToString() + "','" + textBox4.Text.ToString() + "','" + textBox5.Text.ToString() + "','" + strata.ToString() + "','" + Cena1hod.ToString() + "','" + "Aktivny" + "','" + "N/A" + "','" + "N/A" + "','" + "N/A" + "','" + "N/A" + "','" + "N/A" + "')";
